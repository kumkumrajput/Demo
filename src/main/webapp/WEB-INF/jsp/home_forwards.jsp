	...
	<div class="album text-muted">
		<div class="container">
			<div class="row" style="padding-bottom: 10px;">
				<div class="col heading">Forwards</div>
			</div>
			<div class="row">
				<div class="card">
					<div class="boxElem">
						<span class="boxElemSpan"><a href="/commodity/commoditydetails/forwards">Create Forwards</a></span>
					</div>
				</div>
				<div class="card">
					<div class="boxElem">
						<span class="boxElemSpan"><a href="/commodity/commoditydetails/editparameters/editforwards">Edit Forwards</a></span>
					</div>
				</div>
			</div>
	  </div>
