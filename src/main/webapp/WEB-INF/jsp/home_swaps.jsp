	...
	<div class="album text-muted">
		<div class="container">
			<div class="row" style="padding-bottom: 10px;">
				<div class="col heading">Swaps</div>
			</div>
			<div class="row">
				<div class="card">
					<div class="boxElem">
						<span class="boxElemSpan"><a href="/commodity/commoditydetails/swaps">Create Swaps</a></span>
					</div>
				</div>
				<div class="card">
					<div class="boxElem">
						<span class="boxElemSpan"><a href="/commodity/commoditydetails/editparameters/editswaps">Edit Swaps</a></span>
					</div>
				</div>
			</div>
	  </div>
