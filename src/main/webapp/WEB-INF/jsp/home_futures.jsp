	...
	<div class="album text-muted">
		<div class="container">
			<div class="row" style="padding-bottom: 10px;">
				<div class="col heading">Futures</div>
			</div>
			<div class="row">
				<div class="card">
					<div class="boxElem">
						<span class="boxElemSpan"><a href="/commodity/commoditydetails/futures">Create Futures</a></span>
					</div>
				</div>
				<div class="card">
					<div class="boxElem">
						<span class="boxElemSpan"><a href="/commodity/commoditydetails/editparameters/editfutures">Edit Futures</a></span>
					</div>
				</div>
			</div>
	  </div>
